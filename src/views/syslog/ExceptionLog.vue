  ...
  <el-container class="exception-log-page">
    ...
    <el-main class="content">
      ...
      <el-table v-loading="loading" :data="list" class="ofa-table">
        ...
        <el-table-column show-overflow-tooltip prop="Name" label="异常摘要" width="400"></el-table-column>
...
const entity = ref<ISysExceptionLog>(
  Object.assign({})
) // 实体
...
// 显示添加抽屉
function showDrawer(item: ISysExceptionLog) {
  entity.value = item
