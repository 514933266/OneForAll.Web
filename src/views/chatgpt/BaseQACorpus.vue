  ...
  >
    ...
    >
      ...
      <el-form-item label="类型" prop="Type" class="row-item">
        <el-input
          v-model.trim="entity.Type"
          placeholder="请输入训练数据的类型，如医疗"
        ></el-input>
      </el-form-item>
      <el-form-item label="问题" prop="Question" class="row-item">
        <el-input v-model.trim="entity.Question" placeholder="请输入问题">
        </el-input>
      </el-form-item>
      <el-form-item label="答案" prop="Answer" class="row-item">
        <el-input
          ...
          placeholder="请输入参考答案，AI将会根据此内容进行整理回答"
        ></el-input>
      </el-form-item>
...
function get() {
  loading.value = true
  const tenantId =
    searchOption.value.tenantId === '' ? GUID : searchOption.value.tenantId
  API.getPageBaseQACorpus(
    pageIndex.value,
    pageSize.value,
