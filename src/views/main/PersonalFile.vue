	...
	<el-container class="personal-file-page">
		...
		<el-main class="content">
			...
			<div class="person-info-box">
				<el-form status-icon :model="entity" class="person-form" label-width="140px" ref="personFormRef">
							...
							>
								...
								<div v-if="!disabled">
									...
									<el-tooltip
										...
										placement="top"
									>
										<el-checkbox v-if="field.Type === 8" v-model="field.Value" true-value="true" false-value="false">
										</el-checkbox>
									</el-tooltip>
								</div>
							</el-form-item>
...
import FILE_API from '@/apis/oa-api'
